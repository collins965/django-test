...
try:
    ...
    raise RuntimeError("Database configuration failed. Ensure DATABASE_URL is set.") from e
...
SECURE_HSTS_INCLUDE_SUBDOMAINS = config('DJANGO_HSTS_INCLUDE_SUBDOMAINS', default=True, cast=bool)
